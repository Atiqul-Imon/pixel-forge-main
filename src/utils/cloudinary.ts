...
export const PORTFOLIO_IMAGES = {
  ...
  prokrishihub: 'prokrishihub_screenshot', // Placeholder - upload actual image to Cloudinary
  doctorstech: 'doctorstech_screenshot', // Placeholder - upload actual image to Cloudinary
